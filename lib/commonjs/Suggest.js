...
exports.default = exports.SuggestTypes = void 0;
var _reactNative = require("react-native");
const {
  YamapSuggests
} = _reactNative.NativeModules;
let SuggestTypes = exports.SuggestTypes = /*#__PURE__*/function (SuggestTypes) {
...
const getCoordsFromSuggest = suggest => {
  const coords = suggest.uri?.split('?')[1]?.split('&')?.find(param => param.startsWith('ll'))?.split('=')[1];
  if (!coords) return;
